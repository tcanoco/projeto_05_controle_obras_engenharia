...
Aplicação em Python para cadastro, acompanhamento e análise de obras civis, desenvolvida para a disciplina **Programação para Ciência de Dados**.
...
O objetivo do projeto é desenvolver um Sistema de Controle de Obras, executado em console, integrando os conteúdos vistos ao longo da disciplina.
...
O arquivo requirements.txt contém as seguintes dependências necessárias para execução do sistema.
...
Atualização de Progresso	Ajusta porcentagem, status e conclusão	Módulo 1
Registro de Custos	Define custo realizado	Módulo 1
Cálculo de Métricas	Progresso, custo, desvio e atraso	Módulo 1
Persistência em CSV	Leitura e escrita usando Pandas	Módulo 2
DataFrame Resumo	Tabela gerencial da obra	Módulo 2
Relatório de Console	Relatórios individuais e gerais	Módulo 1
Gráficos	Progresso, custo e atraso	Módulo 3
Menu Completo	Sistema interativo no console	Módulo 1
...
Comparação do percentual de conclusão.
...
Dias de atraso comparativos entre obras.
